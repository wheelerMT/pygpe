.. currentmodule:: pygpe.scalar.data_manager

Scalar BEC DataManager
======================

The scalar BEC DataManager handles the wavefunction, grid, and parameter data
of the simulation.
...
.. note::
    ...
    Since the wavefunction array is defined on a CUDA device, the data has to
